# NueVue (PixelOffice-inspired) Technical Specifications and PRD Index

This document is the single source of truth for product requirements and technical design.

## Product Requirement Documents (PRDs)

- [PRD-01 Nexus Web App](../prd/PRD-01-nexus-web-app.md)
- [PRD-02 Platform Services](../prd/PRD-02-platform-services.md)
...
- [Planning and Decision Artifacts (OKR, PRD, ARD, ADR, CRIT, Splits)](../standards/planning-and-decision-artifacts.md)
  - [OKR Template](../standards/templates/OKR-template.md)
  - [ARD Template](../standards/templates/ARD-template.md)
  - [ADR Template](../standards/templates/ADR-template.md)
  - [CRIT Template](../standards/templates/CRIT-template.md)
- [Repo Assessment and Recommendations](./repo-assessment-and-recommendations.md)
